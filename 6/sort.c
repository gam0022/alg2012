...
/* 外部定義の整列関数 */
void str_sel(int [], unsigned); /* 単純選択法 */
void heap(int [], unsigned);	/* ヒープ整列法 */
void str_ins(int [], unsigned); /* 単純挿入法 */
void shell(int [], unsigned);	/* シェル法 */
void bubble(int [], unsigned);	/* バブル整列法 */
void quick(int [], unsigned);	/* クイックソート法 */
